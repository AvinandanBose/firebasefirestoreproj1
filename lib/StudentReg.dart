...
class StudentReg extends StatefulWidget {
  static const String id = 'StudentReg_Screen';
...
//FireStoreStorage
  Future uploadFile() async {
    ...
    String getUrlDownload = await snapshot.ref.getDownloadURL();
    print('Download Link: $getUrlDownload');
    return getUrlDownload.toString();
                ...
                Form(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      //________________PHONE NUMBER____________________________//
                      SizedBox(
                        width: MediaQuery.of(context).size.width * 0.80,
                        child: TextFormField(
                      ...
                      //___________Email Address__________________
                      SizedBox(
                        width: MediaQuery.of(context).size.width * 0.80,
                        child: TextFormField(
