...
import 'package:firebasefirestoreproj1/updateProfilePicture.dart';
...
class _editScreenState extends State<editScreen> {
  ...
  Future<void> updateUser(
      id, name, phone, email, dob, gender, nationality, education, address) {
    setState(() {
      isEditing = true;
    });
                          ...
                          child: MaterialButton(
                            ...
                            onPressed: () {
                              if (formKey.currentState?.validate() == true) {
                                updateUser(widget.id, name, phone, email, dob,
                                    gender, nationality, education, address);
                              }
                              if (isEditing == true) {
